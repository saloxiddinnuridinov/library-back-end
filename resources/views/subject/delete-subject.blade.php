                            ...
                            <div class="card-body">
                                <form class="form theme-form" action="{{route('subject.destroy',['subject' => $id])}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class='mb-3 row'>
                                        ...
                                        <div class='col-sm-9'>
                                            <input class='form-control' disabled  type='text' name='department_id' value='{{$model->department_id}}' placeholder='Department Id'>
                                            @error('department_id')
									...
									<div class='mb-3 row'>
                                        ...
                                        <div class='col-sm-9'>
                                            <input class='form-control' disabled  type='text' name='tag' value='{{$model->tag}}' placeholder='Tag'>
                                            @error('tag')
                                            <p class='text-danger'>{{$message}}</p>
                                            @enderror
                                        </div>
									...
									<div class='mb-3 row'>
                                        ...
                                        <div class='col-sm-9'>
                                            <input class='form-control' disabled  type='text' name='position' value='{{$model->position}}' placeholder='Position'>
                                            @error('position')
                                            <p class='text-danger'>{{$message}}</p>
                                            @enderror
                                        </div>
