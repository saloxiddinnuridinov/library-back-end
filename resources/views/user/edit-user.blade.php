                            ...
                            <div class="card-body">
                                <form class="form theme-form" action="{{route('user.update', ['user' => $model->id])}}" method="POST" enctype="multipart/form-data">
									...
									<div class='mb-3 row'>
                                        ...
                                        <div class='col-sm-9'>
                                            <input class='form-control'  type='text' name='surname' value='{{$model->surname}}' placeholder='Surname'>
                                            @error('surname')
                                            <p class='text-danger'>{{$message}}</p>
                                            @enderror
                                        </div>
									...
									<div class='mb-3 row'>
                                        ...
                                        <div class='col-sm-9'>
                                            <input class='form-control'  type='text' name='qr_code' value='{{$model->qr_code}}' placeholder='Qr Code'>
                                            @error('qr_code')
                                            <p class='text-danger'>{{$message}}</p>
                                            @enderror
                                        </div>
									...
									<div class='mb-3 row'>
                                        ...
                                        <div class='col-sm-9'>
                                            <input class='form-control'  type='text' name='group' value='{{$model->group}}' placeholder='Group'>
                                            @error('group')
                                            <p class='text-danger'>{{$message}}</p>
                                            @enderror
                                        </div>
